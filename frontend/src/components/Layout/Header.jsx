...
const Header = ({ activeHeading }) => {
  ...
  return (
    ...
    <h1 className="mt-3 cursor-pointer" style={{ color: "white", fontSize: "24px" }}>ChittoTatto</h1>
          </div>
          <div>
            <div
                  ...
                  <div>
                    <Link to="/profile">
                      <img
                        src={`${backend_url}${user.avatar}`}
                        alt=""
                        className="w-60 h-60 rounded-full border-3 border-[#0eae88] filter brightness-50"
                        />
                    </Link>
                  </div>
                ) : (
...
<div className={`${styles.button}`}>
            <Link to={`${isSeller ? "/dashboard" : "/shop-create"}`}>
              <h1 className="text-black flex items-center">
                {isSeller ? "Go Dashboard" : "Advertise Food"}{" "}
